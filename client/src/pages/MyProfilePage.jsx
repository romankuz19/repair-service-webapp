...
export const MyProfilePage = () => {
    ...
    >
                   ...
                   <div >
                    ...
                    {changePersonal == true && (
                        <>
                        <h1 className='text-lg text-black text-center mt-3'>Мои данные</h1>
                        <label className='text-xs text-gray-600'>
                                ...
                                </label><label className='text-xs text-gray-600'>
                                        Фамилия:
                                        <input
                                            type='text'
                                            value={secondname}
                    ...
                    {changePas == true && (
                         <>
                         <h1 className='text-lg text-black text-center mt-3'>Смена пароля</h1>
